...
const ProductDetails = () => {
  ...
  const { price, image, title, description } = selectedProduct; //destructing
  ...
  return (
    ...
    >
      ...
      <div>
       ...
       <div>
        <button style={{marginTop:'25px',border:'none',padding:'10px',backgroundColor:'rgb(185,76,76)',color:'#fff',borderRadius:'5px'}}>Sepete ekle</button>
       </div>
